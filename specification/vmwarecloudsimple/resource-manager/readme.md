...
swagger-to-sdk:
  ...
  - repo: azure-resource-manager-schemas
    after_scripts:
      - npm install --prefix generator && npm run postprocessor vmwarecloudsimple/resource-manager --prefix generator && npm install --prefix tools && npm run test-ci --prefix tools
```
...
input-file:
  - $(this-folder)/Microsoft.VMwareCloudSimple/stable/2019-04-01/vmwarecloudsimple.json
